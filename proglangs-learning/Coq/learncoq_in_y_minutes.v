(* Source: https://learnxinyminutes.com/docs/coq/ *)
...
Definition my_id (A : Set) (x : A) : A := x.
Definition my_id2 : forall A : Type, A -> A := fun A x => x.
Compute my_id nat 3. (* 3 : nat *)

(*Note that 'Set' and 'Type' are the same, but 'Prop' isn't!*)
(*Compute Prop.*)
(*Check fun A x => x.*)
...
(*
 *Definition inc_z (x : Z) : Z := x + 1.
 *
 *Extraction "inc_z.hs" inc_z.
 *)
...
(*
 *Compute 2 <= 5. [>This is a Prop! How do they work in Coq?<]
 *Print le.
 *)
...
(* References
  ...
  - [Coq'Art: The Calculus of Inductive
    Constructions](http://www.cse.chalmers.se/research/group/logic/TypesSS05/resources/coq/CoqArt/)
